...
![Схема работы статического сайта](https://cithub.ru/api/files/lec_1_12_1.png)
...
![Схема работы динамического сайта](https://cithub.ru/api/files/lec_1_12_2.png)
...
> **База данных (БД)** — это система для хранения, поиска и управления данными, необходимыми приложению. Веб-приложение взаимодействует с базой через сервер.
...
![Схема работы сайта](https://cithub.ru/api/files/lec_1_22_1.png)
...
![Frontend & Backend](https://cithub.ru/api/files/lec_1_23_1.png)
...
![HTTP & HTTPS](https://cithub.ru/api/files/lec_1_32_1.png)
...
![Жизненный цикл HTTP-запроса](https://cithub.ru/api/files/lec_1_33_1.png)
...
![HTML | CSS | JS](https://cithub.ru/api/files/lec_1_42_1.png)